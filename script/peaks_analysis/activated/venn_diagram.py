...
sets = {
    "H3K4_A": set(binary_matrix.index[binary_matrix['H3K4_A'] == 1]),
    "H3K4_N": set(binary_matrix.index[binary_matrix['H3K4_N'] == 1]),
    "H3K27_A": set(binary_matrix.index[binary_matrix['H3K27_A'] == 1]),
    "H3K27_N": set(binary_matrix.index[binary_matrix['H3K27_N'] == 1]),
}
